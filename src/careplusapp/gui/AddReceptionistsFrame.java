...
public class AddReceptionistsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 540, 340, 80));

        txtEmpId.setBackground(new java.awt.Color(214, 214, 214));
        txtEmpId.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        txtEmpId.setText("id");
        ...
        jPanel1.add(txtEmpId, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 140, 280, 40));
        ...
        jPanel1.add(jcEmpJob, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 320, 280, 40));

        lblEmpName.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        lblEmpName.setText("Receptionist Name");
        jPanel1.add(lblEmpName, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 320, 50));

        lblEmpID.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        lblEmpID.setText("Receptionist ID");
        jPanel1.add(lblEmpID, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 320, 50));
        ...
        jPanel1.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 540, 340, 80));

        Salary1.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        Salary1.setText("Employee ID");
        jPanel1.add(Salary1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, 320, 50));

        Salary3.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        Salary3.setText("Gender");
        jPanel1.add(Salary3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 320, 50));

        txtEmpName1.setBackground(new java.awt.Color(234, 234, 234));
        txtEmpName1.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        jPanel1.add(txtEmpName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 200, 280, 40));

        lblEmpJob1.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        lblEmpJob1.setText("Login ID");
        jPanel1.add(lblEmpJob1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 260, 320, 50));

        txtLogin.setBackground(new java.awt.Color(234, 234, 234));
        txtLogin.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        jPanel1.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 260, 280, 40));

        Salary4.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        Salary4.setText("Retype Password");
        jPanel1.add(Salary4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 440, 320, 50));

        txtReTypePassword.setBackground(new java.awt.Color(234, 234, 234));
        txtReTypePassword.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        jPanel1.add(txtReTypePassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 440, 280, 40));

        txtPassword.setBackground(new java.awt.Color(234, 234, 234));
        txtPassword.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 380, 280, 40));

        Salary5.setFont(new java.awt.Font("Century Gothic", 1, 15)); // NOI18N
        Salary5.setText("Password");
        jPanel1.add(Salary5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 380, 320, 50));

        jcEmpId.setBackground(new java.awt.Color(214, 214, 214));
        jcEmpId.setFont(new java.awt.Font("Century Gothic", 0, 15)); // NOI18N
        jcEmpId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcEmpIdActionPerformed(evt);
            }
        });
        jPanel1.add(jcEmpId, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 80, 280, 40));
    ...
    try{
         ...
         rec.setGender(jcEmpJob.getSelectedItem().toString());
         rec.setReceptionistId(txtEmpId.getText().toString());
         rec.setReceptionistName(txtEmpName1.getText().toString());
         boolean result=ReceptionistDao.addReceptionist(rec);
         if(userAdded && result){
    ...
    private void generateNewId() {
        try{
            ...
            String empId=ReceptionistDao.getNewRecId();
    ...
    private boolean loadEmpId() {
        try{
            Set <String> set = EmpDao.getUnRegisteredReceptionists().keySet();
            if(set.size()==0){
                return false;
            }
            for(String id:set){
