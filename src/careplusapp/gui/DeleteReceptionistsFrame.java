 ...
 * @author hardi
 */
public class DeleteReceptionistsFrame extends javax.swing.JFrame {
    public DeleteReceptionistsFrame() {
    ...
    private void initComponents() {
        ...
        btnDelete.setText("DELETE RECEPTIONIST");
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 420, 620, 90));
        ...
        jPanel1.add(txtEmpName, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 290, 300, 60));
        ...
        jPanel1.add(lblEmpName, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 300, 60));
    ...
    private void jcEmpIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcEmpIdActionPerformed
        try{
            ...
            txtEmpName.setText(ReceptionistDao.getRecNameById(empId));
        }
    ...
    private void loadEmpId() {
        try{
            List<String>docIdList=ReceptionistDao.getAllRecId();
            if(docIdList.size()<1){
    ...
    private void delete(){      
        try{
            boolean result=ReceptionistDao.deleteRecById(jcEmpId.getSelectedItem().toString());
            if(result){
